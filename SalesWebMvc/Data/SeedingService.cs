...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        {
            if(
                this._context.Departament.Any() || // Operação LINQ: Verifica se há dados na tabela
                this._context.SalesRecord.Any() ||
                this._context.Seller.Any()
            ) // Verificará se há dados nas tabelas Departament, SalesRecord e Seller
            { // Se houver algum tipo de dados, não fará nada
                return;
            }

            // Se não houver dados, iremos popular as tabelas, criando objetos do tipo da tabela e por seguinte populando:
            ...
            //02- Populando as tabelas com os objetos criados acima:
            this._context.Departament.AddRange(d1, d2, d3, d4);
            ...
            //03- Confirmando alteração do banco de dados:
